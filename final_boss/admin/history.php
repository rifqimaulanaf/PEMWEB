<?php
    include '../koneksi.php';
    $data = mysqli_query($koneksi,"select * from tb_history");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div  class="d-flex justify-content-center mt-2">
                    <a href="cetak_pdfhistory.php" target="_blank"><button align="center" type="button" class="btn btn-danger fs-5">Cetak PDF <i class="far fa-file-pdf"></i></button></a>
                    <a href="exportexcel.php" class="btn btn-success pull-right">Export Members</a>
                </div>
